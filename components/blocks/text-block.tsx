...
export function TextBlock({ block, dragHandleProps, accentColor = "#FF6B35" }: TextBlockProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-all p-10 relative group border border-border">
          ...
          <div className="flex-1 space-y-4">
            {isEditing ? (
              <Input
                ...
                className="font-bold text-xl h-auto py-2"
              />
            ) : (
              block.title && <h3 className="font-bold text-xl text-foreground leading-tight">{block.title}</h3>
            )}
          </div>
            ...
            {useHtml ? (
              ...
              <ReactMarkdown
                components={{
                  ...
                  p: ({ node, ...props }) => (
                    <p className="mb-4 leading-[1.75] text-[15px] text-muted-foreground" {...props} />
                  ),
                  ul: ({ node, ...props }) => (
                    <ul className="mb-4 space-y-2 text-[15px] text-muted-foreground" {...props} />
                  ),
                  ol: ({ node, ...props }) => (
                    <ol className="mb-4 space-y-2 text-[15px] text-muted-foreground" {...props} />
                  ),
                }}
              >
                {block.content}
